...
public class VendaDAO implements BaseDAO<Venda> {
    ...
    public Venda inserir(Venda entity) {
        ...
        try (
            ...
            throw new BancoDeDadosException("Erro ao inserir venda.", e);
        }
        return entity;
    }
    ...
    public ResultSet buscar(String param) {
        ...
        try {
            ...
            throw new BancoDeDadosException("Erro ao buscar venda.", e);
        }
    }
    ...
    public void alterar(Venda entity) {
        ...
        try (
            ...
            throw new BancoDeDadosException("Erro ao alterar venda.", e);
        }
    }
    ...
    public void deletar(Venda entity) {
        ...
        try (
            ...
            throw new BancoDeDadosException("Erro ao excluir venda.", e);
        }
    }
    ...
    public List<Venda> listar() {
        ...
        try (
            ...
            throw new BancoDeDadosException("Erro ao listar venda.", e);
        }
