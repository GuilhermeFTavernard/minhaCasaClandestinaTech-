...
public class ItemCompraDAO implements BaseDAO<ItemCompra> {
    ...
    public ItemCompra inserir(ItemCompra entity) {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            throw new BancoDeDadosException("Erro ao inserir item de compra.", e);
        }
    ...
    public ResultSet buscar(String param) {
        ...
        try {
            ...
            throw new BancoDeDadosException("Erro ao buscar item de compra.", e);
        }
    }
    ...
    public void alterar(ItemCompra entity) {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            throw new BancoDeDadosException("Erro ao alterar item de compra.", e);
        }
    }
    ...
    public List<ItemCompra> listar() {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql);
            ...
            throw new BancoDeDadosException("Erro ao listar itens de compra.", e);
        }
    ...
    public void deletar(ItemCompra entity) {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            throw new BancoDeDadosException("Erro ao excluir item de compra.", e);
        }
    }
    ...
    public List<ItemCompra> listarPorCompra(int idCompra) {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            throw new BancoDeDadosException("Erro ao listar item de compra.", e);
        }
