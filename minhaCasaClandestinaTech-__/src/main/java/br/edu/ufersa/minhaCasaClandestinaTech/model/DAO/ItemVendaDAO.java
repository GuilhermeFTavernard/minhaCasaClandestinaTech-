...
public class ItemVendaDAO implements BaseDAO<ItemVenda> {
    ...
    public ItemVenda inserir(ItemVenda entity) {
        ...
        try (
            ...
            throw new BancoDeDadosException("Erro ao inserir item de venda.", e);
        }
    ...
    public ResultSet buscar(String param) {
        ...
        try {
            ...
            throw new BancoDeDadosException("Erro ao buscar item de venda.", e);
        }
    }
    ...
    public void alterar(ItemVenda entity) {
        ...
        try (
            ...
            throw new BancoDeDadosException("Erro ao alterar item de venda.", e);
        }
    }
    ...
    public void deletar(ItemVenda entity) {
        ...
        try (
            ...
            throw new BancoDeDadosException("Erro ao excluir item de venda.", e);
        }
    }
    ...
    public List<ItemVenda> listar() {
        ...
        try (
            ...
            throw new BancoDeDadosException("Erro ao listar item de venda.", e);
        }
