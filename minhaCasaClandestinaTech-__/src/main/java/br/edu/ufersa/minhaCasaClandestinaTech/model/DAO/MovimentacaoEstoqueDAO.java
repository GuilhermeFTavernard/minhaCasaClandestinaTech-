...
public class MovimentacaoEstoqueDAO implements BaseDAO<MovimentacaoEstoque> {
    ...
    public MovimentacaoEstoque inserir(MovimentacaoEstoque entity) {
        ...
        try (
            ...
            throw new BancoDeDadosException("Erro ao inserir movimentação de estoque.", e);
        }
    ...
    public ResultSet buscar(String param) {
        ...
        try {
            ...
            throw new BancoDeDadosException("Erro ao buscar movimentação de estoque.", e);
        }
    }
    ...
    public void alterar(MovimentacaoEstoque entity) {
        ...
        try (
            ...
            throw new BancoDeDadosException("Erro ao alterar movimentação de estoque.", e);
        }
    }
    ...
    public List<MovimentacaoEstoque> listar() {
        ...
        try (
            ...
            throw new BancoDeDadosException("Erro ao listar movimentação de estoque.", e);
        }
        return lista;
    }
    ...
    public void deletar(MovimentacaoEstoque entity) {
        ...
        try (
            ...
            throw new BancoDeDadosException("Erro ao excluir movimentação de estoque.", e);
        }
    }
