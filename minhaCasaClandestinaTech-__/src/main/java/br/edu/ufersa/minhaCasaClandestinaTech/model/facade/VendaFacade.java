...
import br.edu.ufersa.minhaCasaClandestinaTech.exception.EstoqueInsuficienteException;
import br.edu.ufersa.minhaCasaClandestinaTech.exception.ValidacaoException;
...
public class VendaFacade {
    ...
    public void realizarVenda(Venda venda) {
        if (venda == null) {
            throw new ValidacaoException("Venda é obrigatório.");
        }
        ...
        for (ItemVenda item : venda.getItensVenda()) {
            ...
            if (equipamento.getQuantidadeEstoque() < item.getQuantidade()) {
                throw new EstoqueInsuficienteException(
                        "Estoque insuficiente para: " + equipamento.getNome()
                );
            }
        }
