...
public class EquipamentoDAO implements BaseDAO<Equipamento> {
    ...
    public Equipamento inserir(Equipamento entity) {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            throw new BancoDeDadosException("Erro ao inserir equipamento.", e);
        }
    ...
    public ResultSet buscar(String param) {
        ...
        try {
            ...
            throw new BancoDeDadosException("Erro ao buscar equipamento.", e);
        }
    }
    ...
    public void alterar(Equipamento entity) {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            throw new BancoDeDadosException("Erro ao alterar equipamento.", e);
        }
    }
    ...
    public List<Equipamento> listar() {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            throw new BancoDeDadosException("Erro ao listar equipamento.", e);
        }
    ...
    public void deletar(Equipamento entity) {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            throw new BancoDeDadosException("Erro ao excluir equipamento.", e);
        }
    }
}